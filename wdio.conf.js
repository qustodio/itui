...
exports.config = {
    ...
    cucumberOpts: {
        ...
        // transpile the qustodio-itui in the projects inhereting this one
        // but not the rest of node_modules
        // we ignore everything in node_modules but qustodio-itui
        requireModule: [['@babel/register', { ignore: [ /node_modules\/(?!qustodio-itui)/ ] }]],
